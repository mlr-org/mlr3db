...
This subsetted table is now used to create a `DataBackendDplyr`.
```{r}
...
* A regression task, based on the previously created `DataBackendDplyr`
...
measures = mlr_measures$mget(c("mse", "time_train", "time_predict"))
```
